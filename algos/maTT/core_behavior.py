...
from algos.psspTT.modules import *

"""
Used during evaluation of policies:
in order to take a look at the q values
Used to analyze weak form of cooperation
Could be used to look at attention
"""
...
class SoftActionSelector(nn.Module):
    ...
    def forward(self, q, deterministic=False, with_logprob=True):
        ...
        return pi_action, logp_pi, q_values
...
class DeepSetmodel(nn.Module):
    ...
    def act(self, obs, deterministic=False):
        with torch.no_grad():
            ...
            a, _, q_values = self.pi(v1+v2, deterministic, False)
            # Tensor to int
            return int(a), q_values
